![](cropland_zindi_image.png)


# **GEOAI Challenge for Cropland Mapping in Dry Environments**
 

Repository to the 1st place solution to [GeoAI cropland mapping challenge](https://zindi.africa/competitions/geoai-challenge-for-cropland-mapping-in-dry-environments) hosted on [Zindi](https://zindi.africa/). Solutions were based on three criteria: Performance, Novelty and Practicability.
...
## [**Datasets used and sources**](notebooks/data_extraction.py)
...
### [**Feature Engineering**](notebooks/feature_engineering.py)
...
![*Figure 1:* Combined Feature Importance](notebooks/imgs/ensemble_shap_vals.png)